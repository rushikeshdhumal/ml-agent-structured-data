# DS-Crew — Engineering Reference (CrewAI implementation)

See the [README](../README.md) for the project overview, including how this
implementation compares to the Azure AI Foundry / Microsoft Agent Framework
one on `feat/maf-workflow`. This document covers setup, the full interactive
walkthrough, configuration, and every architectural decision behind this
branch's implementation in depth.
