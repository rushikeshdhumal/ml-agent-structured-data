# DS-Crew — Engineering Reference

See the [README](../README.md) for the project overview. This document
covers setup, configuration, the HTTP tool service, Azure AI Foundry
operation, observability, evaluation, and every architectural decision in
depth.
...
docs/
  ...
  workflow.mmd        Live-generated pipeline topology (ds-crew-maf --viz)
...
[`workflow.mmd`](workflow.mmd); regenerate it after any change to
